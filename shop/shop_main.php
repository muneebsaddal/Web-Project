...
<?php
    $result = mysqli_query($mysqli, "SELECT item_id, item_name, car_type, item_image, item_price FROM new_cars");
?>
  ...
  <section class="mainContent">
        ...
        <?php
          ...
          while($res = mysqli_fetch_array($result)){
            ...
            echo "<form action='item.php' method='GET'><button type='submit' name='Buy' value='".$var1."' class='buyButton'>Buy</button></form>";
            echo "</article>";
