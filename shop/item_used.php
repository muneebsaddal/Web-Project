...
$itemget = $_GET['Buy'];
$result = mysqli_query($mysqli, "SELECT * FROM used_cars WHERE ucar_id = $itemget");
...
<div class="container"> 
  ...
  <section class="item_descrip">
      <div class="image_half">
        <?php echo "<img  class='item_image' src='".$res['ucar_image']."' width='250px'>"?>
      </div>
      <div class="descrip_half">
        <?php
        echo "<h2>".$res['ucar_name']."</h2>";
        echo "<h4>".$res['car_type']."</h4>";
        echo "<br>";
        echo "<h3>Price: ".$res['ucar_price']."</h3>";
        ?>
