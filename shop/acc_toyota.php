...
<div class="container"> 
  ...
  <div id="content">
    <section class="sidebar">
      <a href="shop_acc.php"><button class="button1 button11" href="shop_main.php">Clear</button></a>
      <div id="menubar">
        <section class="menu">
          <h2>Car</h2>
          <hr>
  ...
  <?php
      $result = mysqli_query($mysqli, "SELECT * FROM accessories WHERE acc_descrip = 'Toyota Corolla 2018'");
  ?>
