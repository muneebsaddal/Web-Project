...
$itemget = $_GET['Buy'];
$result = mysqli_query($mysqli, "SELECT * FROM new_cars WHERE item_id = $itemget");
...
<div class="container"> 
  ...
  <section class="item_descrip">
      <div class="image_half">
        <?php echo "<img  class='item_image' src='".$res['item_image']."' width='250px'>"?>
      </div>
      <div class="descrip_half">
        <?php
        echo "<h2>".$res['item_name']."</h2>";
        echo "<h4>".$res['car_type']."</h4>";
        echo "<br>";
        echo "<h3>Price: ".$res['item_price']."</h3>";
        ?>
